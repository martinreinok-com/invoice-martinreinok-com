...
function App() {
  ...
  return (
    <div className="app">
      ...
      <h3 className="center fs-10">Language button</h3>
      <h3 className="center fs-10">Make the download button 'normal' and accessible when browser compacted</h3>
      <h3 className="center fs-10">Saveable templates for companies? for a case of a reoccuring client</h3>
